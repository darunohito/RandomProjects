...
class ssb_am_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "ssb_am_rx")
        ...
        self.rf_preamp = rf_preamp = False
        self.offset = offset = 100000.0
        self.center_freq = center_freq = 14.263e6
        self.bw = bw = 24e3
        ...
        self.soapy_hackrf_source_0.set_gain(0, 'AMP', rf_preamp)
        ...
        self.mmse_resampler_xx_0 = filter.mmse_resampler_cc(0, (samp_rate/bw))
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(bw, analog.GR_COS_WAVE, offset, 1, 0, 0)
        ...
        self.connect((self.mmse_resampler_xx_0, 0), (self.blocks_multiply_xx_0, 0))
        self.connect((self.soapy_hackrf_source_0, 0), (self.mmse_resampler_xx_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 15e3, 5e3, window.WIN_HAMMING, 6.76))
        self.mmse_resampler_xx_0.set_resamp_ratio((self.samp_rate/self.bw))
        self.soapy_hackrf_source_0.set_sample_rate(0, self.samp_rate)

    def get_rf_preamp(self):
        return self.rf_preamp

    def set_rf_preamp(self, rf_preamp):
        self.rf_preamp = rf_preamp
        self.soapy_hackrf_source_0.set_gain(0, 'AMP', self.rf_preamp)
    ...
    def set_bw(self, bw):
        self.bw = bw
        self.analog_sig_source_x_0.set_sampling_freq(self.bw)
        self.mmse_resampler_xx_0.set_resamp_ratio((self.samp_rate/self.bw))
        self.qtgui_freq_sink_x_0.set_frequency_range(0, self.bw)
        self.qtgui_freq_sink_x_1.set_frequency_range(0, self.bw)




def main(top_block_cls=ssb_am_rx, options=None):
